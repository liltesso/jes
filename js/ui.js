    ...
    <div style="padding-bottom:100px;overflow-x:hidden;">
      <section class="hero" id="top" style="position:relative; min-height:450px;">
        ...
        <div class="product-hero liquid-hero" style="cursor:pointer;" onclick="setTab('catalog')">
          ...
          <img src="uploads/hero_bottles.png" alt="SmokeLab Bottles" class="liquid-hero-img" style="max-width:100%; object-fit:contain;">
        </div>

        <div class="hero-card">
          <h2>${t("best_shop")}</h2>
          <p>${t("best_shop_desc")}</p>
        </div>
        
        <div class="px5" style="margin-bottom:32px; text-align:center;">
          <button class="order-big" onclick="setTab('catalog')">${t("order_button")}</button>
        </div>
      </section>
  ...
  return `
    <div class="card" style="margin:0 20px 20px;overflow:hidden;">
      ...
      <div style="padding:12px 16px 16px;">
        ...
        ${getDesc(p) ? `<div style="color:rgba(255,255,255,0.4);font-size:13px;margin-bottom:10px;">${getDesc(p)}</div>` : ""}
