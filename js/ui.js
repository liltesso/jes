...
const TOPUP_METHODS = [
  { id: "mono", name: "Monobank", icon: "🖤", hint: "${t("mono")}" },
  { id: "privat", name: "Privat24", icon: "💚", hint: "${t("privat")}" },
  { id: "visa_mc", name: "Visa / Mastercard", icon: "💳", hint: "${t("visa")}" },
  { id: "other", name: t("other_bank"), icon: "🏦", hint: "${t("other")}" },
];
