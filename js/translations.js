export const TRANSLATIONS = {
  ru: {
    ...
    who_we_are: "КТО МЫ?",
    who_we_are_text: "Legit Assets — магазин жидкостей, pod-систем, одноразовых устройств. Мы быстро обрабатываем заказы и подбираем товары под твои предпочтения.",
    ...
    footer_club: "MARSHAL", footer_geo: "GERMANY",
    ...
    add: "Добавить",
    best_shop_desc: "прямо под рукой",
    bought_together: "С этим товаром часто покупают",
    buy_now: "В корзину",
    cancel: "Отмена",
    cart_subtitle: "Проверь заказ и применяй промокод",
    catalog_empty: "Ничего не найдено",
    catalog_subtitle: "Товары в наличии",
    history_subtitle: "Ваши заказы",
    invited: "Приглашено",
    out_of_stock: "Нет в наличии",
    out_of_stock_pill: "Нет в наличии",
    profile_subtitle: "Ваши данные и бонусы",
    promo_invalid: "Промокод не найден или неактивен",
    ref_link: "Реферальная ссылка",
    review_btn: "Отправить отзыв",
    review_desc: "Напиши коротко, что понравилось.",
    search_placeholder: "Поиск товаров...",
    status_canc: "Отменён",
    status_done: "Выполнен",
    status_proc: "В обработке",
    status_sent: "Отправлен/Готов",
    topup: "Пополнить баланс",
    topup_btn: "Пополнить на",
    topup_method: "Способ оплаты",
    topup_subtitle: "Выберите сумму и способ оплаты",

    delivery: "Доставка",
    payment: "Оплата",
    confirm: "Подтверждение",
    free_shipping: "Бесплатная доставка",
    free_shipping_done: "Достигнута! 🎉",
    sum: "Сумма",
  ...
  de: {
    ...
    add: "Hinzufügen",
    best_shop_desc: "immer griffbereit",
    bought_together: "Wird oft zusammen gekauft",
    buy_now: "In den Warenkorb",
    cancel: "Abbrechen",
    cart_subtitle: "Bestellung prüfen und Rabattcode anwenden",
    catalog_empty: "Nichts gefunden",
    catalog_subtitle: "Verfügbare Produkte",
    history_subtitle: "Deine Bestellungen",
    invited: "Eingeladen",
    out_of_stock: "Nicht verfügbar",
    out_of_stock_pill: "Nicht verfügbar",
    profile_subtitle: "Deine Daten und Boni",
    promo_invalid: "Rabattcode nicht gefunden oder inaktiv",
    ref_link: "Empfehlungslink",
    review_btn: "Bewertung senden",
    review_desc: "Schreib kurz, was dir gefallen hat.",
    search_placeholder: "Produkte suchen...",
    status_canc: "Storniert",
    status_done: "Abgeschlossen",
    status_proc: "In Bearbeitung",
    status_sent: "Versendet/Bereit",
    topup: "Guthaben aufladen",
    topup_btn: "Aufladen um",
    topup_method: "Zahlungsart",
    topup_subtitle: "Betrag und Zahlungsart wählen",
    ...
    free_shipping_done: "Erreicht! 🎉",
    sum: "Summe",

    cat_title: "Kategorien",
    new_arrivals: "Neuheiten 🔥",
    hit_title: "Bestseller 💎",
    show_all: "Alle anzeigen",

    best_shop: "DER BESTE SHOP", best_shop_desc: "immer griffbereit", order_button: "KATALOG",
    about_us: "ÜBER UNS",
    who_we_are: "WER WIR SIND?",
    who_we_are_text: "Legit Assets — ein Geschäft für E-Liquids, Pod-Systeme und Einweggeräte. Wir bearbeiten Bestellungen schnell und passen Produkte an deine Vorlieben an.",
    ...
    footer_club: "MARSHAL", footer_geo: "DEUTSCHLAND",
