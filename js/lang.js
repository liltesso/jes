...
const TRANSLATIONS = {
  ru: {
    chat1: "привет, где купить?",
    chat2: "салют, знаю хороший магаз",
    chat3: "спасибо, щас закажу",
  ...
  de: {
    chat1: "hallo, wo kaufen?",
    chat2: "hey, ich kenne einen guten Shop",
    chat3: "danke, ich bestelle jetzt",
