  ...
  return `
    <div style="padding-bottom:100px;overflow-x:hidden;animation:fadeIn 0.4s ease-out;">
      ...
      <section class="hero" id="top" style="padding-bottom:20px;">
        <div style="position:relative; height: 420px; width: 100%;">
          ...
          <div class="product-hero liquid-hero" style="cursor:pointer; top: 160px; height: 260px;" onclick="setTab('catalog')">
            ...
            <img src="${window.HERO_IMAGE}" style="width:70%;height:70%;object-fit:contain;filter:drop-shadow(0 20px 40px rgba(192,38,211,0.7));position:relative;z-index:1;">
          </div>
        </div>
      ...
      <section class="about" id="about" style="padding: 0 20px;">
        <div class="big-title"><span>SMOKE LAB</span><h2>НЕМНОГО О НАС</h2></div>
        <div class="info-card">
          <h3>КТО МЫ?</h3><div class="line"></div>
          <p>SMOKE LAB — топовый магазин жидкостей, pod-систем, одноразовых устройств и картриджей. Мы постоянно обновляем ассортимент и предлагаем только лучшую продукцию.</p>
        </div>
        <div class="info-card">
      ...
      <section class="split-section" style="padding: 0 20px;">
        ...
        <div class="info-card">
          ...
          <button class="main-btn" style="width:100%;margin-top:10px;padding:14px;background:#c026d3;color:#fff;border-radius:12px;font-weight:bold;border:none;box-shadow: 0 4px 15px rgba(192, 38, 211, 0.4);" onclick="window.open('https://t.me/smokelab_support', '_blank')">ЗАДАТЬ ВОПРОС</button>
        </div>
      </section>

      <section class="reviews" id="reviews" style="padding: 0 20px;">
        <div class="big-title"><span>SMOKE LAB</span><h2>ОТЗЫВЫ ПОКУПАТЕЛЕЙ</h2></div>
