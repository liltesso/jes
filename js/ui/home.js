function renderHome() {
  ...
  return `
    <div style="padding-bottom:100px;overflow-x:hidden;">
      <section class="hero" id="top" style="position:relative; min-height:450px;">
        <div class="logo-card">
          <h1 class="logo">
        ...
        <div class="product-hero liquid-hero" style="cursor:pointer;" onclick="setTab('catalog')">
          <div class="liquid-hero-glow"></div>
          <img src="/icon-192.png" style="width:70%;height:70%;object-fit:contain;filter:drop-shadow(0 20px 40px rgba(192,38,211,0.7));position:relative;z-index:1;" onerror="this.style.display='none'">
        </div>
        
        <div class="hero-card" style="background: linear-gradient(135deg, rgba(192,38,211,0.2) 0%, rgba(124,58,237,0.2) 100%); border: 1px solid rgba(192,38,211,0.3); border-radius: 20px; padding: 24px; text-align: center; margin: 0 20px 24px;">
