const TOPUP_METHODS = [
  { id: 'mono', name: 'Monobank', icon: '🐈', hint: t("pay_mono") || 'Перевод на карту' },
  { id: 'sparkasse', name: 'Sparkasse', icon: '🏦', hint: t("pay_sparkasse") || 'IBAN Европа' },
  { id: 'usdt', name: 'USDT (TRC20)', icon: '🪙', hint: 'Криптовалюта' }
];
