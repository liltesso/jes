        ...
        <div style="margin-top:32px;">
          ...
          <div class="no-scroll" style="display:flex;gap:12px;overflow-x:auto;padding:0 20px 20px;scroll-snap-type:x mandatory;">
            ${state.activeProductRecs.map(rec => {
              ...
              const img = rec.photo ? `<img loading="lazy" src="${getPhoto(rec.photo)}" style="width:100%;height:100%;object-fit:cover;" onerror="this.onerror=null; this.src='/placeholder.jpg';">` : `<div style="width:100%;height:100%;background:${rBg};display:flex;align-items:center;justify-content:center;font-size:30px;">🧴</div>`;
              return `
