...
function productCard(p) {
  ...
  const photoBlock = p.photo
    ? `<img data-src="${getPhoto(p.photo)}" style="width:100%;aspect-ratio:1/1;object-fit:contain;background:rgba(255,255,255,0.02);border-radius:12px;box-shadow:0 8px 20px rgba(0,0,0,0.3);" onerror="this.outerHTML=${JSON.stringify(placeholder).replace(/"/g, "&quot;")};">`
    : placeholder;
  return `
